(define-keyboard-mappings "mvs"
  ...
  (lambda ()
    ...
    (if (boundp 'org-mode-map)
      ...
      (add-hook 'org-load-hook (lambda () (define-key org-mode-map (kbd "C-t") 'org-todo)))))
  ...
  (lambda ()
    ...
    (if (boundp 'org-mode-map)
        (define-key org-mode-map (kbd "C-t") 'transpose-chars)
      (remove-hook 'org-load-hook (lambda () (define-key org-mode-map (kbd "C-t") 'org-todo))))))
